...
//        public Action<BinarySerializationWriter_old, T> CreateDelegate<T>()
//        {
//            return (writer, arg2) => {};
//        }
...
//        {
//            return CreateMethodBuilder(typeof(void), new Type[]{typeof(BinarySerializationWriter_old), typeof(T)}).GetILGenerator();            
//        }
//    }
